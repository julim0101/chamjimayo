...
// UnSmile 데이터셋 채굴 보강 — 직장 맥락 욕설·인격비하만 선별(집단 슬러 제외)
const UNSMILE_AUG=["씨팔","시팔","씨바","쌍놈","쌍년","좆같","좃같","개같","개소리","개수작","꺼져","닥치","엿먹","지랄하","발광","정신병","정신나간","정신 나갔","무뇌","뇌가 없","대가리","골이 비","골빈","극혐","찐따","멍청","저능","띨빵","머갈","밥통","인간 쓰레기","쓰레기같"];
const TOXIC_LEXICON = {"욕설·비속어":PROFANITY,"능력·인격 비하":DEMEANING,"협박·불이익 암시":THREAT,"인격 부정":DENIAL,"욕설·비하(보강)":UNSMILE_AUG};
const TOXIC_WEIGHTS = {"욕설·비속어":1.0,"능력·인격 비하":0.75,"협박·불이익 암시":0.9,"인격 부정":0.9,"욕설·비하(보강)":0.85};
const SUBTLE = {
